        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypeOfWarehouse = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OnlineDurationSeconds = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StockMovements_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UnitInStocks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UnitInStocks_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UnitInStocks_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UnitInStocks_Warehouses_WarehouseId",
                        column: x => x.WarehouseId,
                        principalTable: "Warehouses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUser_IsLoginConfirmCodeActive",
                table: "AspNetUsers",
                column: "IsLoginConfirmCodeActive");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Category_IsActive_IsDeleted",
                table: "Categories",
                columns: new[] { "IsActive", "IsDeleted" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OutboxEvent_Id",
                table: "OutboxEvent",
                column: "Id",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_OutboxEvent_IsActive_IsDeleted",
                table: "OutboxEvent",
                columns: new[] { "IsActive", "IsDeleted" });

            migrationBuilder.CreateIndex(
                name: "IX_OutboxEvent_IsProcessed",
                table: "OutboxEvent",
                column: "IsProcessed");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockMovement_AppUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockMovement_IsActive_IsDeleted",
                table: "StockMovements",
                columns: new[] { "IsActive", "IsDeleted" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockMovement_Quantity",
                table: "StockMovements",
                column: "Quantity");

            migrationBuilder.CreateIndex(
                name: "IX_UnitInStock_AppUserId",
                table: "UnitInStocks",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_UnitInStock_Id",
                table: "UnitInStocks",
                column: "Id",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UnitInStock_IsActive_IsDeleted",
                table: "UnitInStocks",
                columns: new[] { "IsActive", "IsDeleted" });

            migrationBuilder.CreateIndex(
                name: "IX_UnitInStock_ProductId",
                table: "UnitInStocks",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_UnitInStock_Quantity",
                table: "UnitInStocks",
                column: "Quantity");

            migrationBuilder.CreateIndex(
                name: "IX_UnitInStock_WarehouseId",
                table: "UnitInStocks",
                column: "WarehouseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Warehouse_IsActive_IsDeleted",
                table: "Warehouses",
                columns: new[] { "IsActive", "IsDeleted" });
        }
